...
\gantttitle{Project timeline in months/weeks}{30} \\
\gantttitle{FEBR}{4}
\gantttitle{MARCH}{5}\gantttitle{APRIL}{4}\gantttitle{MAY}{4}\gantttitle{JUNE}{5}\gantttitle{JULY}{4}\gantttitle{AUG.}{4} \\
\gantttitle[title label node/.append style={below left=-8pt and -7pt}]{\footnotesize\textit{Week}\quad1}{1}
\gantttitlelist
{2,...,30}{1} \\ 
\ganttbar{Training}{1}{6} \\
\ganttbar{Sys. Des.}{5}{8}\\
\ganttbar{Sys. Dev.}{9}{17} \\ 
\ganttbar{Test Unit Des.}{18}{18}\\ 
\ganttbar{Test Unit Dev.}{19}{20}\\
